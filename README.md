...
Simple CMS package for Payload CMS with GitHub CI/CD integration
...
```bash
bun add @donotdev/cms
# or
npm install @donotdev/cms
```
...
- [Report a bug](https://github.com/donotdev/cms/issues/new?template=bug_report.md)
- [Request a feature](https://github.com/donotdev/cms/issues/new?template=feature_request.md)
